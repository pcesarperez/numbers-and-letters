...
public final class SpanishNumeralValues {
	...
	/**
	 * Gets the value corresponding to the rule <code>r0</code>.
	 * <p/>
	 * The numeral "cero" always yields the value 0.
	 *
	 * @return The value corresponding to the rule <code>r0</code>.
	 */
	public Integer v0 ( ) {
		return 0;
	}
	...
	/**
	 * Gets the value corresponding to the rule <code>r1</code>.
	 * <p>
	 * <code>r1</code> is a straightforward rule, with just one value to yield.
	 *
	 * @param numeral Numeral of the rule <code>r1</code> of which the value is to be extracted.
	 * @return The value corresponding to the rule <code>r1</code>.
	 */
	...
	/**
	 * Gets the value corresponding to the rule <code>r2</code>.
	 * <p>
	 ...
	 * @return The value corresponding to the rule <code>r2</code>.
	 */
